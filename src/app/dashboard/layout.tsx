...
import { AccountSwitcher } from "@/components/layout/sidebar/account-switcher";
    ...
    <SidebarProvider defaultOpen={defaultOpen}>
      ...
      <SidebarInset
        ...
        <header
          ...
          className={cn(
            "flex h-15 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-15",
